...
;~ report
(ins :condition (Vcolor <> nil Gcontrol <> reported) :action (stroop-report -> Gtask) :description "Object seen, formulate an answer")
;;~ wait
;(ins :condition (Vcolor <> nil Gcontrol = reported) :action (idle -> Gtask) :description "Object seen, formulate an answer")
